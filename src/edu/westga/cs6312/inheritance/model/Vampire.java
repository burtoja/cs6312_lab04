...
public class Vampire extends Monster {
	...
	/**
	 * 3 parameter constructor for Vampire objects. If invalid health value is sent,
	 * the default value of 100 will be set. If invalid value is sent for the pints
	 * of blood needed, then the default value of zero will be set.
	 *
	...
	/**
	 * 2 parameter constructor for Vampire objects. The pints of blood needed is set
	 * to zero. If invalid health value is sent, the default value of 100 will be
	 * set.
	 *
	 * @param name   the name of the Vampire
	 * @param health the health of the Vampire
