...
class ZombieWhenSoundMadeSetOrGet {
	 ...
	 * set at creation and get its sound using the getter:
	 * Name: Carl
	 * Health: 100 (default)
	 * Sound: Meow
	 * Expected Result: Meow
	 */
	@Test
	...
	/**
	 * Test the setSoundMade method.  Make Zombie with the following information 
	 * set at creation then change the sound to Arff using setSoundMade
	 * and get its name using the getter:
	 * Original Name: Carl
	 * Health: 100 (default)
	 * Original Sound: Meow
	 * New Sound: Arff
	 * Expected Result: Arff
	 */
	@Test
