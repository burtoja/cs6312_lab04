...
/**
 * This will serve as the test class for the Monster health setter and getter methods
 * 
...
class MonsterWhenHealthSetOrGet {
	...
	/**
	 * Test the getHealth method.  Make Monster with the following information 
	 * set at creation and get its health using the getter:
	 * Name: Carl
	 * Health: 100
	 * Expected Result: 100
	 */
	 ...
	 * set at creation then change the health to 75 using setHealth
