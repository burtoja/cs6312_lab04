...
class VampireWhenPintsOfBloodNeededSetOrGet {
	...
	/**
	 * Test the getPintsOfBloodNeeded method.  Make Vampire with the following information 
	 * set at creation and get its pints of blood needed using the getter:
	 * Name: Carl
	 * Health: 80
	 * Pints Needed: 5
	 * Expected Result: 5
	...
	/**
	 * Test the setPintsOfBloodNeeded method.  Make Vampire with the following information 
	 * set at creation then change the pints needed using setPintsOfBloodNeeded
	 * and get its name using the getter:
	 * Name: Carl
	 * Health: 80
	 * Original Pints Needed: 5
	 * New Pints Needed: 3
	 * Expected Result: 3
	 */
	@Test
	...
	/**
	 * Test the setPintsOfBloodNeeded method when invalid value sent.  
	 * Make Vampire with the following information 
	 * set at creation then change the pints needed using setPintsOfBloodNeeded
	 * and get its name using the getter:
	 * Name: Carl
	 * Health: 80
	 ...
	 * Test the setPintsOfBloodNeeded method when invalid value sent.  
	 * Make Vampire with the following information 
	 * set at creation then change the pints needed using setSoundMade
	 * and get its name using the getter:
	 * Name: Carl
	 * Health: 80
	 * Original Pints Needed: 5
